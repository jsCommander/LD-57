...
static func get_log_message(type: String, component_name: String, message: String) -> String:
	var timestamp = Logger.get_timestamp()
...
static func log_debug(component_name: String, message: String):
	...
	var log_message = Logger.get_log_message("DEBUG", component_name, message)
	print(log_message)

static func log_info(component_name: String, message: String):
	var log_message = Logger.get_log_message("INFO", component_name, message)
	print(log_message)

static func log_warn(component_name: String, message: String):
	var log_message = Logger.get_log_message("WARN", component_name, message)
	print(log_message)
	push_warning(log_message)

static func log_error(component_name: String, message: String):
	var log_message = Logger.get_log_message("ERROR", component_name, message)
	print(log_message)
